...
const AddProduct = props => {
  ...
  const handleSubmit = async event => {
    event.preventDefault();
    try {
      const response = await fetch("http://20.193.146.8:8080/api/data/productmaster", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "bg-white shadow-lg rounded-lg w-1/2 h-2/3 fixed top-[10%] left-[25%] z-[5] text-center "
    ...
    className: "w-[90%]  mx-3 p-2 bg-white m-2  rounded-lg relative top-5"
    ...
    className: "w-[100%]  mx-2 p-2 bg-white m-2  rounded-lg relative"
  }, /*#__PURE__*/React.createElement(Button, {
    type: "submit"
  }, "Add Product"))))));
};
