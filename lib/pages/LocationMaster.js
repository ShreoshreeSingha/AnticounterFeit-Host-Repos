...
const LocationMaster = () => {
  ...
  const handleSearchSubmit = event => {
    ...
    const results = data.filter(item => item && item.Key?.includes(filterParam) || item.doc.locationType.includes(filterParam) || item.doc.locationName.includes(filterParam) || item.doc.city.includes(filterParam) || item.doc.state.includes(filterParam) || item.doc.country.includes(filterParam) || item.doc.streetAddress.includes(filterParam) || item.doc.storageCapacity.includes(filterParam));
    setData(results);
  };
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, showPopup && /*#__PURE__*/React.createElement(FileUpload, {
  ...
  }), modalIsOpen && /*#__PURE__*/React.createElement(ADDLOCATION, {
    onCloseRecieved: closePopup
    ...
    to: "/addLocation"
  }, "Add location")), /*#__PURE__*/React.createElement(Button, {
    onClick: handleClick
  ...
  }, "Location Name"), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    class: "px-6 py-4 font-medium text-gray-900"
  }, "Location Type"), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    class: "px-6 py-4 font-medium text-gray-900"
  }, "Street Address"), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    class: "px-6 py-4 font-medium text-gray-900"
    ...
    scope: "col",
    class: "px-6 py-4 font-medium text-gray-900"
  }, "Storage Capacity"), /*#__PURE__*/React.createElement("th", {
    scope: "col",
    class: "px-6 py-4 font-medium text-gray-900"
  }, "Status"))), data != "" ? /*#__PURE__*/React.createElement("tbody", {
    ...
    class: "px-6 py-2"
  }, item.doc.locationName), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.locationType), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.streetAddress), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.city), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.state), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.country), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.storageCapacity), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, item.doc.status), /*#__PURE__*/React.createElement("td", {
    class: "px-6 py-2"
  }, /*#__PURE__*/React.createElement("div", {
