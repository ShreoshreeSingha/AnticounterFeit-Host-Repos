...
function DistributerIncomingBatch() {
  ...
  const filterData = () => data.filter((item) => item.Record.route[1] === "S1");

  return (
    <>
      <Header category="Page" title="WareHouse | Incoming Batches" />
      <table>
        <thead>
          <tr>
            <th>Key</th>
...
export default DistributerIncomingBatch;
